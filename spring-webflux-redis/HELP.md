...
* The original package name 'tech.luiscunha.spring-webflux-redis' is invalid and this project uses 'tech.luiscunha.springwebfluxredis' instead.
...
```
$ docker run --rm spring-webflux-redis:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/spring-webflux-redis
```
