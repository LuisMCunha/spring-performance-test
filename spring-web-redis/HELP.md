...
* The original package name 'tech.luiscunha.spring-web-redis' is invalid and this project uses 'tech.luiscunha.springwebredis' instead.
...
```
$ docker run --rm -p 8080:8080 spring-web-redis:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/spring-web-redis
```
